...
// note that buttonPressed is not the opposite of buttonReleased!
// buttonPressed is only true if both feet bumpers have been pressed
// buttonReleased is only true if both feet bumpers have been released
