...
class CPP_MetaActionWriter(CLMetaGenWriter):
    ...
    def __init__(self, machineDef):
        super(CPP_MetaActionWriter, self).__init__(machineDef)
    ...
    def _insertMachineNamespace(self):
        replaceIndex = self.namespaces.index(CPP_MetaActionWriter.REPLACE_WITH_MACHINE_NAMESPACE)
