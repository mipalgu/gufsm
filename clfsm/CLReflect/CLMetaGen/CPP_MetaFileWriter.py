...
class CPP_MetaFileWriter(CLMetaGenWriter):
    ...
    INCLUDES = ['#include "CLReflectAPI.h"', '#include <sstream>', '#include <iostream>', '#include <cstdlib>', '#include <cstring>', '#include <stdint.h>', '#include <gufsm/clfsm/clfsm_machine_loader.h>']
