...
//
#ifndef clfsm_epuckMeanderLinesByGSM_State_Align_After_Right_Turn_h
#define clfsm_epuckMeanderLinesByGSM_State_Align_After_Right_Turn_h
      ...
      namespace FSMepuckMeanderLinesByGSM
      {
        namespace State
        {
            class Align_After_Right_Turn: public CLState
            {
                ...
                {
                public:
                    Transition_1(int toState = 39): CLTransition(toState) {}
